...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2026-04-09T00:00:00');
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2027-04-09T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `We've been together❤️: <b>${days}</b> Days<br>`+
      `Our anniversary ❤️: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
